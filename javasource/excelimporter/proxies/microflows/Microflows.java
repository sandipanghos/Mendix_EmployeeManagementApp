...
public class Microflows
{
	...
	public static java.lang.String mxObjectAttributeTypesEnumToString(IContext context, mxmodelreflection.proxies.PrimitiveTypes _attributeTypes)
	{
		Map<java.lang.String, Object> params = new HashMap<>();
		params.put("AttributeTypes", _attributeTypes == null ? null : _attributeTypes.name());
		return (java.lang.String) Core.microflowCall("ExcelImporter.MxObjectAttributeTypesEnumToString").withParams(params).execute(context);
	}
	...
	public static mxmodelreflection.proxies.PrimitiveTypes stringToMxObjectAttributeTypesEnum(IContext context, java.lang.String _input)
	{
		Map<java.lang.String, Object> params = new HashMap<>();
		params.put("Input", _input);
		java.lang.String result = (java.lang.String) Core.microflowCall("ExcelImporter.StringToMxObjectAttributeTypesEnum").withParams(params).execute(context);
		return result == null ? null : mxmodelreflection.proxies.PrimitiveTypes.valueOf(result);
	}
